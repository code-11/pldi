...
structure Evaluator = struct
  ...
  fun primCons [I.VInt a,I.VList b]= I.VList (ref (I.VInt a)::b)
    | primCons [I.VBool a,I.VList b]= I.VList (ref (I.VBool a)::b)
    | primCons [I.VList a,I.VList b] = I.VList (ref (I.VList a)::b)
    | primCons _ = evalError ["type error in primCons"]

  fun primHd [I.VList (r::rs)]= !r
    | primHd _=evalError ["type error in primHd"]

  fun primTl [I.VList (r::rs)] = I.VList rs
    | primTl _ = evalError ["type error in primTl"]
  
  fun primUpHd [I.VList (r::rs), b]= r:=b
    | primUpHd _ =evalError ["type error in primUpHd"]

(*  fun primNil []= I.VList []
    | primNil _ = evalError ["yper error in primNil"]*)
      ...
      [("+", Func (["a","b"], I.EPrimCall (primPlus,
       ...
       ("=", Func (["a","b"], I.EPrimCall (primEq,
					   [I.EIdent "a",
					    I.EIdent "b"]),
		    [])),
(*       ("nil",Func ([],I.EPrimCall(primNil, []),[]))*)
       ("nil",Con (I.VList [])),
       ("cons",Func(["a","b"],I.EPrimCall (primCons,
        [I.EIdent "a",
        I.EIdent "b"]),
        [])),
       ("hd",Func(["a"],I.EPrimCall (primHd,[I.EIdent "a"]),[])),
       ("tl",Func(["a"],I.EPrimCall (primTl,[I.EIdent "a"]),[])),
       ("updateHd",Proc(["a","b"],I.SPrimCall (primUpHd,[I.EIdent "a",I.EIdent "b"]),[]))
        ]
